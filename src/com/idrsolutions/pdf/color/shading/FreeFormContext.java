...
//    private final float[][] CTM;
    ...
    public FreeFormContext(final GenericColorSpace shadingColorSpace,
    ...
    private void process() {
        while (reader.getPointer() < reader.getTotalBitLen()) {
            int flag = (int) reader.getPositive(bitsPerFlag);
            Point2D p = getPointCoords();
            float[] cc = new float[]{1f, 1f, 1f, 1f};
