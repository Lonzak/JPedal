...
public class AxialContext implements PaintContext {
    ...
    public AxialContext(final AffineTransform xform, final int renderingType, final boolean isPrinting, final int offX, final int offY, final int minX, final int pHeight, final float scaling, final boolean[] isExtended, final float[] domain,
...
////@mark
		...
		for (int y = 0; y < h; y++) {
			...
			for (int x = 0; x < w; x++) {
                ...
                //if(1==2 && DecoderOptions.isRunningOnMac)
...
//                    }
                    ...
                    //if(DecoderOptions.isRunningOnMac && PdfDecoder.javaVersion<1.6){ //fix bug in code
