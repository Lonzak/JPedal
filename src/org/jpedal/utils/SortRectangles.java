...
/**
 * arranges rectangles into order by size width smallest first<br>
 * Used by grouping algorithms<br>
 * Needs to copy data into separate array so program does not alter order of original<br>
 * We provide a sorted array of indices so data itself is nor sorted<br>
 * <br>
