...
/**
 * return date of time now int shortdate format <br>
...
public class TimeNow {
	...
	final static public String getShortTimeNow() {
		...
		String format_string = now.get(Calendar.YEAR) + format(1 + now.get(Calendar.MONTH)) + format(now.get(Calendar.DAY_OF_MONTH))
