...
public interface CustomMessageHandler {
	...
	/**
	 * example below public boolean showMessage(Object message){
	 * 
	 * if(message instanceof String) System.out.println("Message="+message); else{ System.out.println("Object is a component ="+message); }
	 * 
	 * //do not show JPedal message dialog return false; } /
	 **/
	 ...
	 * public String requestInput(Object[] args) {
	 * 
	 * System.out.println("input requested - parameters passed in (String or components"); return null; } /
	 **/
	 ...
	 * public int requestConfirm(Object[] args) {
	 * 
	 * System.out.println("input requested - parameters passed in (String or components"); return -1; } /
	 **/
