...
public class Options {
	...
	/**
	 * allow user to process image - implements {@link org.jpedal.external.ImageHandler} examples in org.jpedal.examples.handlers and sample code to
	 * use commented out in Viewer
	 * */
	...
	/**
	 * allows user to over-ride form creation code with own - needs to implement {@link org.jpedal.objects.acroforms.creation.FormFactory}
	 **/
	...
	/**
	 * allows user to replace whole forms action Handling code - needs to implement {@link org.jpedal.objects.acroforms.actions.ActionHandler} It is
	 * recommended you look at Options.ExpressionEngine and Options.LinkHandler for most purposes
	 */
	...
	/**
	 * allows user to link in their own code for Javascript validation - needs to implement {@link org.jpedal.external.LinkHandler}
	 */
