...
public interface ImageHandler {
	 ...
	 * @param optionsApplied
	 *            - any options already done (ie 90 rotate) - values from org.jpedal.constants.PDFImageProcessing
	 * @param upside_down
	 *            - AffineTransform applied to page
	 * @param currentImageFile
	 *            - name of file stored on disk
	 * @param g2
	 *            - Graphics2D render object
	 * @param renderDirect
	 *            -if being rendered straight to g2 (ie bufferedImage)
	 * @param objectStore
	 *            - JPedals class to access cached images
	 * @param isPrinting
	 * @return true to ignore standard JPedal routines and false to use.
	 */
	boolean drawImageOnscreen(BufferedImage image, int optionsApplied, AffineTransform upside_down, String currentImageFile, Graphics2D g2,
