...
public interface GUIFactory {
	 ...
	 */
	public JScrollPane createPane(JTextPane text_pane, String content, boolean useXML) throws BadLocationException;
	...
	/**
	 * called by nav functions to decode next page (in GUI code as needs to manipulate large part of GUI)
	 */
	...
	/**
	 * allow access to top button bar directly - used by ContentExtractor. For general use it is recommended you use addButton method
	 */
