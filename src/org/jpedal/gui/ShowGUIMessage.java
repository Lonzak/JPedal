 ...
 * <p>
 * <b>Note </b> these methods are not part of the API and is not guaranteed to be in future versions of JPedal.
 * </p>
 * 
 */
public class ShowGUIMessage {
	...
	final static public void showGUIMessage(String user_message, JTextPane messages, String title) {
		...
		display_scroll_pane.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		...
		if (user_message != null) display.add(new JLabel("<HTML><BODY><I>" + user_message + "</I></BODY></HTML>", 0), BorderLayout.SOUTH);
		 ...
		 * create the dialog
		 */
		JOptionPane.showConfirmDialog(contentPane, /* parentComponent */display, /* message */title, JOptionPane.DEFAULT_OPTION, /* optionType */
	...
	final static public void showGUIMessage(String user_message, JLabel messages, String title) {
		...
		// add a user-defined message
		if (user_message != null) display.add(new JLabel(user_message, 0), BorderLayout.SOUTH);
	...
	final static public void showGUIMessage(String user_message, ImageIcon image, String title) {
		...
		if (user_message != null) display.add(new JLabel(user_message), BorderLayout.SOUTH);
