...
public class CommandListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		int ID;
		if (source instanceof GUIButton) ID = ((GUIButton) source).getID();
		else
			if (source instanceof SwingMenuItem) ID = ((SwingMenuItem) source).getID();
			else
				if (source instanceof SwingCombo) ID = ((SwingCombo) source).getID();
				else ID = ((SwingID) source).getID();
