...
public class SingleViewTransferHandler extends BaseTransferHandler {
	...
	private static final long serialVersionUID = 1261205449129510134L;
	...
	protected void openFile(String file) throws PdfException {
		...
		boolean isValid = ((testFile.endsWith(".pdf")) || (testFile.endsWith(".fdf")) || (testFile.endsWith(".tif")) || (testFile.endsWith(".tiff"))
				|| (testFile.endsWith(".png")) || (testFile.endsWith(".jpg")) || (testFile.endsWith(".jpeg")));

		if (isValid) {
			this.currentCommands.openTransferedFile(file);
		}
		else {
