...
public class MCObject extends PdfObject {
	...
	private String ActualText, IDTree, Lang = null, T;

	public MCObject(String ref) {
		super(ref);

		this.objType = PdfDictionary.MCID;
	}
	...
	public String getName(int id) {
		...
		switch (id) {
			...
			case PdfDictionary.Root:
				...
				// setup first time
				if (this.Root == null && this.rawRoot != null) this.Root = new String(this.rawRoot);
	...
	public String getTextStreamValue(int id) {
		...
		switch (id) {
			...
			case PdfDictionary.ActualText:
				...
				// setup first time
				if (this.ActualText == null && this.rawActualText != null) this.ActualText = StringUtils.getTextString(this.rawActualText, false);
			...
			case PdfDictionary.ID:
				...
				// setup first time
				if (this.ID == null && this.rawID != null) this.ID = new String(this.rawID);
			...
			case PdfDictionary.IDTree:
				...
				// setup first time
				if (this.IDTree == null && this.rawIDTree != null) this.IDTree = new String(this.rawIDTree);
			...
			case PdfDictionary.Lang:
				...
				// setup first time
				if (this.Lang == null && this.rawLang != null) this.Lang = new String(this.rawLang);
			...
			case PdfDictionary.T:
				...
				// setup first time
				if (this.T == null && this.rawT != null) this.T = new String(this.rawT);
