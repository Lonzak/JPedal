...
public class OutlineObject extends PdfObject {
	...
	String Fstring = null, Title = null;
	byte[] rawFstring = null, rawTitle = null;

	private PdfObject A, Fdict, First = null, Next, Last;
	private byte[][] Dest;

	public OutlineObject(String ref) {
		super(ref);
	}

	public OutlineObject(int ref, int gen) {
		super(ref, gen);
	}

	public OutlineObject(int type) {
		super(type);
	}
