	...
	public void setTextStreamValue(int id, byte[] value) {
		...
		switch (id) {
			...
			case PdfDictionary.Keywords:
				this.rawKeywords = value;
				break;

			case PdfDictionary.ModDate:
				this.rawModDate = value;
				break;

			case PdfDictionary.Producer:
				this.rawProducer = value;
				break;

			case PdfDictionary.Subject:
				this.rawSubject = value;
				break;
	...
	public String getName(int id) {
		...
		switch (id) {
			...
			case PdfDictionary.Trapped:
				...
				// setup first time
				if (this.Trapped == null && this.rawTrapped != null) this.Trapped = new String(this.rawTrapped);
	...
	public String getTextStreamValue(int id) {
		...
		switch (id) {
			...
			case PdfDictionary.Author:
				...
				// setup first time
				if (this.Author == null && this.rawAuthor != null) this.Author = new String(this.rawAuthor);
			...
			case PdfDictionary.CreationDate:
				...
				// setup first time
				if (this.CreationDate == null && this.rawCreationDate != null) this.CreationDate = new String(this.rawCreationDate);
			...
			case PdfDictionary.Creator:
				...
				// setup first time
				if (this.Creator == null && this.rawCreator != null) this.Creator = new String(this.rawCreator);
			...
			case PdfDictionary.Keywords:
				...
				// setup first time
				if (this.Keywords == null && this.rawKeywords != null) this.Keywords = new String(this.rawKeywords);
			...
			case PdfDictionary.ModDate:
				...
				// setup first time
				if (this.ModDate == null && this.rawModDate != null) this.ModDate = new String(this.rawModDate);
			...
			case PdfDictionary.Producer:
				...
				// setup first time
				if (this.Producer == null && this.rawProducer != null) this.Producer = new String(this.rawProducer);
			...
			case PdfDictionary.Subject:
				...
				// setup first time
				if (this.Subject == null && this.rawSubject != null) this.Subject = new String(this.rawSubject);
			...
			case PdfDictionary.Title:
				...
				// setup first time
				if (this.Title == null && this.rawTitle != null) this.Title = new String(this.rawTitle);
